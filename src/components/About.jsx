...
const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="bg-black text-white py-12 px-4 sm:px-20 flex-1" id="about">
        {/* Introduction Section */}
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl sm:text-5xl font-extrabold flex items-center gap-3 mb-6">
            <FaUserGraduate className="text-blue-400" /> Introduction
          </h2>
          <p className="text-base sm:text-lg leading-7 sm:leading-8 text-gray-300 px-1 sm:px-0">
          ...
          <AnimatePresence mode="wait">
            {activeTab === 'timeline' && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -50 }}
                className="max-w-2xl mx-auto space-y-6 text-left px-3 sm:px-0"
              >
                <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md hover:shadow-blue-500 transition-shadow">
            ...
            {activeTab === 'achievements' && (
              <motion.div
                ...
                className="max-w-2xl mx-auto space-y-6 text-left px-3 sm:px-0"
              >
                <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md hover:shadow-yellow-400 transition-shadow">
                ...
                <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md hover:shadow-green-400 transition-shadow">
                  <h4 className="text-xl font-semibold flex items-center gap-2">
                ...
                <div className="bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md hover:shadow-red-400 transition-shadow">
                  <h4 className="text-xl font-semibold flex items-center gap-2">
